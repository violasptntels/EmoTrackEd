...
export default function ReflectionPage() {
  ...
  const [analyzedEmotion, setAnalyzedEmotion] = useState<string | null>(null)
  ...
  const generateSummary = (text: string, emotion: string) => {
    ...
    return `${emotionDescriptions[emotion as keyof typeof emotionDescriptions]}. ${shortText}`
  }
